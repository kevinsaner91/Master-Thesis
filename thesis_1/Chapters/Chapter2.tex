...
In their experiments, Chauhan and Vig \parencite*{Chauhan2015} used the same approach for different types of anomalies in ECGs such as premature ventricular contractions or atrial premature contractions. 
...
\begin{figure}[h]
	...
	\decoRule
	\caption[CNN]{CNN \parencite{Munir2019}}
	\label{fig:CNN}
...
\begin{figure}[h]
	...
	\decoRule
	\caption[MC-DCNN]{MC-DCNN \parencite{Zheng2014}}
	\label{fig:MC-DCNN}
...
\begin{figure}[h]
	...
	\decoRule
	\caption[U-Net]{U-Net \parencite{Wen2019}}
	\label{fig:U-Net}
\end{figure}
...
\textcolor{red}{Another advantage of learning in
