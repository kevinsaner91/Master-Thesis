...
\thesistitle{Comparing Neural Network Architectures on Multivariate Time Series} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\textbf{AUC} & \textbf{A}rea \textbf{U}nder the \textbf{Curve}\\
