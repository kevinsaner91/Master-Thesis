...
model <- keras_model_sequential() %>%
  ...
  layer_lstm(units = 24, return_sequences = TRUE) %>%
  layer_dense(units = 5)
...
save_model_hdf5 (model, "LSTM_Predictor_GHL", include_optimizer = TRUE)
...
lines(result[1:5000,]$x,data[5001:10000,]$RT_level,type="l",col="green")

plot(result[1:5000,]$x,result[1:5000,]$RT_temperature.T, type="l", col="red")
lines(result[1:5000,]$x,data[5001:10000,]$RT_temperature.T,type="l",col="green")

plot(result[1:5000,]$x,result[1:5000,]$HT_temperature.T, type="l", col="red")
lines(result[1:5000,]$x,data[5001:10000,]$HT_temperature.T,type="l",col="green")

plot(result[1:5000,]$x,result[1:5000,]$inj_valve_act, type="l", col="red")
lines(result[1:5000,]$x,data[5001:10000,]$inj_valve_act,type="l",col="green")

plot(result[1:5000,]$x,result[1:5000,]$heater_act, type="l", col="red")
lines(result[1:5000,]$x,data[5001:10000,]$heater_act,type="l",col="green")
